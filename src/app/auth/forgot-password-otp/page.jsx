  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        router.push(`/auth/reset-password?token=${result?.data}`);
          ...
          <div className="w-full max-w-md bg-white rounded-lg p-8 shadow-sm">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <button
                ...
                className={`w-full bg-indigo-600 cursor-pointer text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors ${
